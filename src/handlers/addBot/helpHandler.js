...
export function helpHandler(chatId, userId, bot) {
    if (admins.includes(userId)) {
        return bot.sendMessage(chatId, 'Помощь по командам:\n' +
            ...
            '/edit код_фильма_который_нужно_поменять новое_кол-во_серий новое_название_фильма\n' +
            'Если хочешь оставить кол-во серий или новое название прежним напиши -')
